...
3. Преобразование признаков:  
    `user_agent` и `request_ts` разбиты на дополнительные колонки
    **Label Encoding** и **Ordinal Encoding** для категориальных признаков
4. Удаление нерелевантных и слабокоррелирующих признаков на основе анализа корреляции.
...
3. Убедитесь, что входные файлы (`geo_info.csv`, `referer_vectors.csv`, и т.д.) находятся в той же директории.
